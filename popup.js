...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const API_KEY = 'AIzaSyADaGm6l_y6A9wOAkfZ1eINK7tK5U0_VIY';  // Replace with your actual YouTube Data API key
  const API_URL = 'https://dagshub.com/MohammoD2/Youtube-Comment-Analysis-.mlflow';
